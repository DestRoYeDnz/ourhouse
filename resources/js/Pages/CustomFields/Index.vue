<template>
  ...
  <vue3-snackbar top right :duration="4000"></vue3-snackbar>
    ...
    <div class="flex items-top justify-between mb-8">
      <div class="mb-4 text-3xl font-medium text-gray-700">Custom Attributes</div>
      <div class='flex flex-col'>
        <BreezeButton @click="addModalOpen = !addModalOpen" class="w-full">
          Add a Custom Attribute
        </BreezeButton>
        <span class='font-bold float-right text-xs text-indigo-400 hover:underline'><a href='#'>What is a Custom Attribute?</a></span>
      </div>
        ...
        <div class="px-4 py-2 -mx-3">
          <div class="mx-3">
            ...
            <p class="text-sm text-gray-600">
              It dosn't look like you have added any Custom Attributes.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="px-4 py-2 -mx-3 w-full">
          <div class="flex items-center justify-between mx-3">
            <div>
              <span class="font-semibold text-yellow-500">Verify Email</span>
